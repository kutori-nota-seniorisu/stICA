...
for seg_i = 1
    ...
    %% 保存变量
    savepath = ['./Data/experiment/' file_date 'S1M1L' num2str(level) 'T' num2str(trial) '_C' num2str(params.k) '_' flag_decomp 'm_' num2str(probe) '.mat'];
